...
public class ProjectAppiumGoogleKeepBonus {
    // Driver Declaration
    ...
    public void addNote(){
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(AppiumBy.id("menu_icon")));
        driver.findElement(AppiumBy.id("menu_icon")).click();
